...
$(".search-box").on('touchstart',function(e) {
	e.stopPropagation();
});
...
function initialize(){
  ...
  if(containerWidth <= 767) {
	...
	$('html').on('touchstart', function(e) {
		$('.page-menu li:not(.current)').hide();
	});

	$(".page-menu__menu").on('touchstart',function(e) {
		$('.page-menu li:not(.current)').show();
		e.stopPropagation();
	});
...
$('.supplies-page__svh-box').click(function(){
	var title = $(this).attr('title');
	// console.log(title);
	$(".supplies-page__comment-body").text(title);
});

$('.supplies-page__post').click(function(){
	var title = $(this).attr('title');
	// console.log(title);
	$(".supplies-page__comment-body").text(title);
});
